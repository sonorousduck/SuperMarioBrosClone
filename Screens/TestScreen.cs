...
namespace MarioClone
{
    class TestScreen : Screen
    {
        ...
        public override void SetupGameObjects()
        {
            ...
            //TiledMapComponent tiledMapComponent = new(Content.Load<TiledMap>("Maps/TopDownTestMap"));

            //systemManager.Add(tiledMapComponent.GetCollisionLayer("Colliders"));
            ...
            GameObject player = Player.Create(new Vector2(10, 10), Vector2.One);
